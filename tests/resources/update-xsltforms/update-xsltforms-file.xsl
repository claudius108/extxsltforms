...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
	xmlns:default="http://www.w3.org/1999/xhtml" version="2.0">
	...
	<xsl:template match="xsl:template[@match = 'xforms:model|xforms:show|xforms:hide']">
		<xsl:element name="xsl:template" namespace="http://www.w3.org/1999/XSL/Transform">
			<xsl:attribute name="match"><xsl:value-of select="concat(@match, '|xforms:extension|xforms:transform|xforms:replace')" /></xsl:attribute>
